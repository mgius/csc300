...
% is the difference between books and movies significant?
% yes, because all of my examples are for books.
%The first content prohibition is clear and specific.  Definitions of pornography can vary, but there are clear precedents that have been established to help determine what is and is not pornographic.  The case of  Miller v. California defined what is now called the Miller Test for obscenity to determine if content falls under the definition of ``obscenity,'' or speech that is not protected by the first amendment.  \cite{MillerVsCA}.  

%\begin{itemize}
%\item whether "the average person, applying contemporary community standards" would find that the work, taken as a whole, appeals to the prurient interest
%\end{itemize}

%In any case, the wording in this policy appears to be directed at film publishers rather than book publishers.
